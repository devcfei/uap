#ifndef _UAP_UI_TEXTURE_IMPL_H_
#define _UAP_UI_TEXTURE_IMPL_H_
...
namespace uap
{
    ...
    public:
        ...
        static Result createInstance(ID3D11Device *d3dDevice, ITexture **ppiTexture)
        {
